...
import cv from '../assets/Costilla Guillermo.pdf'
...
export default function Nav() {
    const menuItems = [
        ...
        {
            title: "Curriculum Vitae", href: { cv }, icon: <><svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-user" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#00abfb" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    return (
        <Navbar className="bg-inherit w-full">
            ...
            <NavbarContent className="hidden sm:flex gap-4 justify-center w-full bg-inherit" justify="between">
                <NavbarBrand>
                    <h1 className="text-blue-600 text-2xl font-bold font-permanent-marker">Guille<span className="text-amber-500 font-permanent-marker">Dev</span></h1>
                </NavbarBrand>
                <NavbarItem>
                    <Link className="font-bold hover:text-sky-700" href="https://www.linkedin.com/in/guillermo-costilla-6772a725a/" target="_blank" rel="noopener noreferrer">
                ...
                <NavbarItem>
                    <Link className="font-bold hover:text-sky-700" href="https://github.com/Guillermo-Costilla" target="_blank" rel="noopener noreferrer">
                ...
                <NavbarItem>
                    <Link className="font-bold hover:text-sky-700" href="mailto: gcostilla96@gmail.com" target="_blank" rel="noopener noreferrer">
